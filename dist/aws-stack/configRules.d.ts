 ...
 */
export declare function addConfigRules(stack: Construct): void;
/**
 ...
 * The static `SecMarker` property marks the subscription for security-related identification or processing.
 */
export declare class Rule extends events.Rule {
    static [SecMarker]: boolean;
}
/**
 ...
 * The static `SecMarker` property marks the subscription for security-related identification or processing.
 */
export declare class SnsTopic extends targets.SnsTopic {
    static [SecMarker]: boolean;
}
